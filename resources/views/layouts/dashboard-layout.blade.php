<!DOCTYPE html>
    ...
    <head>
        ...
        <meta content="Your barber app." name="description" />
        <meta content="Hysers Companys" name="author" />
        <!-- App favicon -->
            ...
            <div class="content-page">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                <script>document.write(new Date().getFullYear())</script> © {{ config('app.name') }} - hysers.com
                            </div>
                            <div class="col-md-6">
